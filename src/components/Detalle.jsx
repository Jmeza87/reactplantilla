const Detalle = ({ item }) => {
    const modalId = `modal-${item.id}`; // Asegúrate de que el ID sea válido
    return (
        <div className="modal fade" id={modalId} tabIndex={-1} aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-theme="dark">
                    ...
                    <div className="modal-body">
                        <div className="row py-2">
                            ...
                            <div className="col-md-7">
                                ...
                                <h4>Garantía: <span className="fw-bold">{item.warrantyInformation}</span></h4>
